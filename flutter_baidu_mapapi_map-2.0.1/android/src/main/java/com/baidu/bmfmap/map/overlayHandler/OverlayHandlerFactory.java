...
public class OverlayHandlerFactory {
    ...
    public OverlayHandlerFactory(BMFMapController bmfMapController, MethodChannel methodChannel) {
        init(bmfMapController, methodChannel);
    }

    private void init(BMFMapController bmfMapController, MethodChannel methodChannel) {
