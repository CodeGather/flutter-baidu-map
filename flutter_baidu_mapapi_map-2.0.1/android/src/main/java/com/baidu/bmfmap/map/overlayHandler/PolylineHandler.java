...
import static com.baidu.bmfmap.utils.Constants.MethodProtocol.MarkerProtocol.sMapAddMarkerMethod;
...
public class PolylineHandler extends OverlayHandler {
    ...
    private boolean setOptions(String id, Map<String, Object> polylineOptionsMap,
        ...
        Boolean isMove = new TypeConverter<Boolean>().getValue(polylineOptionsMap, "isMove");
