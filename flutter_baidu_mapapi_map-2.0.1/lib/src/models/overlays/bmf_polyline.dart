...
import '../../../flutter_baidu_mapapi_map.dart';
...
class BMFPolyline extends BMFOverlay {
  ...
  BMFPolyline.fromMap(Map map)
    ...
    if (map['coordinates'] != null) {
      coordinates = [] as List<BMFCoordinate>;
  ...
  Map<String, Object?> toMap() {
    return {
      ...
      'width': this.width,
      'colors': this.colors?.map((color) => color.value.toRadixString(16)).toList(),
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> ?coordinates,
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {
      'id': this.Id,
      'member': 'coordinates',
