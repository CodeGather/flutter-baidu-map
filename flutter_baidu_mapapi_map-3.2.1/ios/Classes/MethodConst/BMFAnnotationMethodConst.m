...
NSString *const kBMFMapSelectMarkerMethod = @"flutter_bmfmap/marker/selectMarker";
NSString *const kBMFMapDeselectMarkerMethod = @"flutter_bmfmap/marker/deselectMarker";
NSString *const kBMFMapDidAddMarkerMethod = @"flutter_bmfmap/marker/didAddMarker";
NSString *const kBMFMapShowMarkersMethod = @"flutter_bmfmap/marker/showMarkers";
