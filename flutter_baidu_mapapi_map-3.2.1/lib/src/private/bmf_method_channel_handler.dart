...
class BMFMethodChannelHandler {
  ...
  /// 动画轨迹当前位置回调
  BMFTraceOverlayAnimationUpdatePositionCallback? _traceOverlayAnimationUpdatePositionCallback;
  ...
  dynamic handlerMethod(MethodCall call) async {
    switch (call.method) {
      ...
      case BMFOverlayCallbackMethodId.kMapOnClickedOverlayCallback:
        {
          if (this._mapOnClickedOverlayCallback != null) {
            ...
            polyline.methodChannel = _methodChannel;
      ...
      case BMFOverlayCallbackMethodId.kTraceOverlayAnimationUpdatePositionCallback:
        {
