...
@class BTKQueryTrackProcessOption;

NS_ASSUME_NONNULL_BEGIN
/// 查询Track时的纠偏选项
/// 查询Track的最新位置、轨迹里程、轨迹点等操作中，如果需要返回纠偏后的结果，需要通过此类设置纠偏参数
@interface BTFQueryTrackProcessOption : BTFModel
...
@property (nonatomic, assign) NSUInteger transportMode;

/// BTFQueryTrackProcessOption => BTKQueryTrackProcessOption
